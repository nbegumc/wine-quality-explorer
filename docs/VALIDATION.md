...
The numerical experiment was run using Python 3.12.14, NumPy 2.3.5, pandas 2.2.3, scikit-learn 1.8.0, and pyAgrum 3.1.1. The data checksum and all row indices are saved in `dist/results.json`.
